...
Pod::Spec.new do |s|
 ...
 # s.license      = "MIT (example)"
  ...
  s.source       = { :git => "https://github.com/GetuiLaboratory/getui-sdk-ios-cocoapods.git", :tag => "1.4.3" }
  ...
  s.preserve_paths = "libGeTuiSdk-1.4.3.a"
  s.ios.vendored_library = "libGeTuiSdk-1.4.3.a"
